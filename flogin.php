...
if($_POST['login'] == "Login")
{
	...
	$qry2   = "SELECT * FROM faculty WHERE femail='$u'";
	$ins = mysqli_query($con,$qry2);
	$row=mysqli_fetch_array($ins);

	
	
	if($u == $row['femail'] && $p == $row['fpassword']   )
	{
...
<head>
<meta charset="utf-8">
<title>Login Portal for Faculty</title>
...
<br>
<br>
<input type="submit" value="Login" name="login"/> &nbsp;	<a href="faculty_signup.php" > Sign up </a>
	</fieldset></center>
<!-- </fieldset> -->
</form>
</div>
